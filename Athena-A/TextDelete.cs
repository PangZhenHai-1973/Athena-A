...
namespace Athena_A
{
    public partial class TextDelete : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog open = new OpenFileDialog())
            {
                ...
                if (open.ShowDialog() == DialogResult.OK)
                {
                    ...
                    textBox1.Text = s;
                    ANSI_Encoding();
                    Task.Factory.StartNew(() => DeleteTask(s));
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (al1.Count > 0)
            {
                ...
                {
                    MessageBox.Show("请指定删除内容。", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                ...
                else
                {
                    ...
                    moveStrBackgroundWorker.DoWork += DeleteStrBackgroundWorker_DoWork;
                    moveStrBackgroundWorker.RunWorkerCompleted += DeleteStrBackgroundWorker_RunWorkerCompleted;
                    moveStrBackgroundWorker.RunWorkerAsync();
                }
            }
        }

        private void DeleteStrBackgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            Control.CheckForIllegalCrossThreadCalls = false;
        ...
        private void DeleteStrBackgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            textBox2.Enabled = true;
            panel1.Enabled = true;
            textBox1.BackColor = System.Drawing.Color.White;
        ...
        private void TextDelete_DragDrop(object sender, DragEventArgs e)
        {
        ...
        private void TextDelete_DragEnter(object sender, DragEventArgs e)
        {
        ...
        private void TextDelete_Shown(object sender, EventArgs e)
        {
            comboBox3.Text = "ANSI";
            comboBox2.Text = "OR";
